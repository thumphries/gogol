...
--
-- /See:/ <https://cloud.google.com/vision/ Google Cloud Vision API Reference> for @vision.operations.cancel@.
module Network.Google.Resource.Vision.Operations.Cancel
    (
    -- * REST Resource
...
-- | A resource alias for @vision.operations.cancel@ method which the
