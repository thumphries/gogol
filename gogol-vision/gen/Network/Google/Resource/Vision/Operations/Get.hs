...
-- API service.
--
-- /See:/ <https://cloud.google.com/vision/ Google Cloud Vision API Reference> for @vision.operations.get@.
module Network.Google.Resource.Vision.Operations.Get
    (
    -- * REST Resource
...
-- | A resource alias for @vision.operations.get@ method which the
