...
--
-- /See:/ <https://cloud.google.com/vision/ Google Cloud Vision API Reference> for @vision.operations.delete@.
module Network.Google.Resource.Vision.Operations.Delete
    (
    -- * REST Resource
...
-- | A resource alias for @vision.operations.delete@ method which the
