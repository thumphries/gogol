...
-- id.
--
-- /See:/ <https://cloud.google.com/vision/ Google Cloud Vision API Reference> for @vision.operations.list@.
module Network.Google.Resource.Vision.Operations.List
    (
    -- * REST Resource
...
-- | A resource alias for @vision.operations.list@ method which the
