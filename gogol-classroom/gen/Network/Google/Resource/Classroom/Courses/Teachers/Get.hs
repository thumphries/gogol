...
ctgtPp :: Lens' CoursesTeachersGet Bool
ctgtPp = lens _ctgtPp (\ s a -> s{_ctgtPp = a})
...
-- | OAuth bearer token.
ctgtBearerToken :: Lens' CoursesTeachersGet (Maybe Text)
ctgtBearerToken
  = lens _ctgtBearerToken
      (\ s a -> s{_ctgtBearerToken = a})
