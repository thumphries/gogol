...
-- either in PNG, JPEG, or GIF format. The provided URL can be at most 2 kB
-- in length.
...
-- time. If not set or if you set this to a value that exceeds the video
-- duration, the video will be played until its end.
