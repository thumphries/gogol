...
data AccountTreeRequestAccountSettings = AccountTreeRequestAccountSettings'
    { _atrasSharingWithOthers :: !(Maybe Bool)
    , _atrasADMobReporting :: !(Maybe Bool)
    , _atrasSharingWithGoogleSales :: !(Maybe Bool)
    , _atrasSharingWithGoogleSupport :: !(Maybe Bool)
    , _atrasSharingWithGoogleAnySales :: !(Maybe Bool)
    , _atrasSharingWithGoogleProducts :: !(Maybe Bool)
    } deriving (Eq,Show,Data,Typeable,Generic)
...
accountTreeRequestAccountSettings = 
    AccountTreeRequestAccountSettings'
    { _atrasSharingWithOthers = Nothing
    , _atrasADMobReporting = Nothing
    , _atrasSharingWithGoogleSales = Nothing
    , _atrasSharingWithGoogleSupport = Nothing
    , _atrasSharingWithGoogleAnySales = Nothing
    , _atrasSharingWithGoogleProducts = Nothing
    }

atrasSharingWithOthers :: Lens' AccountTreeRequestAccountSettings (Maybe Bool)
atrasSharingWithOthers
  = lens _atrasSharingWithOthers
      (\ s a -> s{_atrasSharingWithOthers = a})

atrasADMobReporting :: Lens' AccountTreeRequestAccountSettings (Maybe Bool)
atrasADMobReporting
  = lens _atrasADMobReporting
      (\ s a -> s{_atrasADMobReporting = a})

atrasSharingWithGoogleSales :: Lens' AccountTreeRequestAccountSettings (Maybe Bool)
atrasSharingWithGoogleSales
  = lens _atrasSharingWithGoogleSales
      (\ s a -> s{_atrasSharingWithGoogleSales = a})

atrasSharingWithGoogleSupport :: Lens' AccountTreeRequestAccountSettings (Maybe Bool)
atrasSharingWithGoogleSupport
  = lens _atrasSharingWithGoogleSupport
      (\ s a -> s{_atrasSharingWithGoogleSupport = a})

atrasSharingWithGoogleAnySales :: Lens' AccountTreeRequestAccountSettings (Maybe Bool)
atrasSharingWithGoogleAnySales
  = lens _atrasSharingWithGoogleAnySales
      (\ s a -> s{_atrasSharingWithGoogleAnySales = a})

atrasSharingWithGoogleProducts :: Lens' AccountTreeRequestAccountSettings (Maybe Bool)
atrasSharingWithGoogleProducts
  = lens _atrasSharingWithGoogleProducts
      (\ s a -> s{_atrasSharingWithGoogleProducts = a})
          ...
          = withObject "AccountTreeRequestAccountSettings"
              (\ o ->
                 AccountTreeRequestAccountSettings' <$>
                   (o .:? "sharingWithOthers") <*>
                     (o .:? "admobReporting")
                     <*> (o .:? "sharingWithGoogleSales")
                     <*> (o .:? "sharingWithGoogleSupport")
                     <*> (o .:? "sharingWithGoogleAnySales")
                     <*> (o .:? "sharingWithGoogleProducts"))
...
instance ToJSON AccountTreeRequestAccountSettings
        ...
        toJSON AccountTreeRequestAccountSettings'{..}
          = object
              (catMaybes
                 [("sharingWithOthers" .=) <$>
                    _atrasSharingWithOthers,
                  ("admobReporting" .=) <$> _atrasADMobReporting,
                  ("sharingWithGoogleSales" .=) <$>
                    _atrasSharingWithGoogleSales,
                  ("sharingWithGoogleSupport" .=) <$>
                    _atrasSharingWithGoogleSupport,
                  ("sharingWithGoogleAnySales" .=) <$>
                    _atrasSharingWithGoogleAnySales,
                  ("sharingWithGoogleProducts" .=) <$>
                    _atrasSharingWithGoogleProducts])
...
data AccountTreeResponseAccountSettings = AccountTreeResponseAccountSettings'
    { _aSharingWithOthers :: !(Maybe Bool)
    , _aADMobReporting :: !(Maybe Bool)
    , _aSharingWithGoogleSales :: !(Maybe Bool)
    , _aSharingWithGoogleSupport :: !(Maybe Bool)
    , _aSharingWithGoogleAnySales :: !(Maybe Bool)
    , _aSharingWithGoogleProducts :: !(Maybe Bool)
    } deriving (Eq,Show,Data,Typeable,Generic)
...
accountTreeResponseAccountSettings = 
    AccountTreeResponseAccountSettings'
    { _aSharingWithOthers = Nothing
    , _aADMobReporting = Nothing
    , _aSharingWithGoogleSales = Nothing
    , _aSharingWithGoogleSupport = Nothing
    , _aSharingWithGoogleAnySales = Nothing
    , _aSharingWithGoogleProducts = Nothing
    }

aSharingWithOthers :: Lens' AccountTreeResponseAccountSettings (Maybe Bool)
aSharingWithOthers
  = lens _aSharingWithOthers
      (\ s a -> s{_aSharingWithOthers = a})

aADMobReporting :: Lens' AccountTreeResponseAccountSettings (Maybe Bool)
aADMobReporting
  = lens _aADMobReporting
      (\ s a -> s{_aADMobReporting = a})

aSharingWithGoogleSales :: Lens' AccountTreeResponseAccountSettings (Maybe Bool)
aSharingWithGoogleSales
  = lens _aSharingWithGoogleSales
      (\ s a -> s{_aSharingWithGoogleSales = a})

aSharingWithGoogleSupport :: Lens' AccountTreeResponseAccountSettings (Maybe Bool)
aSharingWithGoogleSupport
  = lens _aSharingWithGoogleSupport
      (\ s a -> s{_aSharingWithGoogleSupport = a})

aSharingWithGoogleAnySales :: Lens' AccountTreeResponseAccountSettings (Maybe Bool)
aSharingWithGoogleAnySales
  = lens _aSharingWithGoogleAnySales
      (\ s a -> s{_aSharingWithGoogleAnySales = a})

aSharingWithGoogleProducts :: Lens' AccountTreeResponseAccountSettings (Maybe Bool)
aSharingWithGoogleProducts
  = lens _aSharingWithGoogleProducts
      (\ s a -> s{_aSharingWithGoogleProducts = a})
...
instance ToJSON AccountTreeResponseAccountSettings
        ...
        toJSON AccountTreeResponseAccountSettings'{..}
          = object
              (catMaybes
                 [("sharingWithOthers" .=) <$> _aSharingWithOthers,
                  ("admobReporting" .=) <$> _aADMobReporting,
                  ("sharingWithGoogleSales" .=) <$>
                    _aSharingWithGoogleSales,
                  ("sharingWithGoogleSupport" .=) <$>
                    _aSharingWithGoogleSupport,
                  ("sharingWithGoogleAnySales" .=) <$>
                    _aSharingWithGoogleAnySales,
                  ("sharingWithGoogleProducts" .=) <$>
                    _aSharingWithGoogleProducts])
