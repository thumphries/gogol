...
--
-- /See:/ <https://developers.google.com/apps-script/api/ Google Apps Script API Reference> for @script.projects.deployments.delete@.
module Network.Google.Resource.Script.Projects.Deployments.Delete
    (
    -- * REST Resource
...
pddPp :: Lens' ProjectsDeploymentsDelete Bool
pddPp = lens _pddPp (\ s a -> s{_pddPp = a})
...
-- | OAuth bearer token.
pddBearerToken :: Lens' ProjectsDeploymentsDelete (Maybe Text)
pddBearerToken
  = lens _pddBearerToken
      (\ s a -> s{_pddBearerToken = a})
