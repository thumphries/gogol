...
--
-- /See:/ <https://developers.google.com/apps-script/api/ Google Apps Script API Reference> for @script.projects.deployments.get@.
module Network.Google.Resource.Script.Projects.Deployments.Get
    (
    -- * REST Resource
...
pdgPp :: Lens' ProjectsDeploymentsGet Bool
pdgPp = lens _pdgPp (\ s a -> s{_pdgPp = a})
...
-- | OAuth bearer token.
pdgBearerToken :: Lens' ProjectsDeploymentsGet (Maybe Text)
pdgBearerToken
  = lens _pdgBearerToken
      (\ s a -> s{_pdgBearerToken = a})
