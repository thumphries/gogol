...
--
-- /See:/ <https://developers.google.com/apps-script/api/ Google Apps Script API Reference> for @script.projects.deployments.create@.
module Network.Google.Resource.Script.Projects.Deployments.Create
    (
    -- * REST Resource
...
pdcPp :: Lens' ProjectsDeploymentsCreate Bool
...
-- | OAuth bearer token.
pdcBearerToken :: Lens' ProjectsDeploymentsCreate (Maybe Text)
pdcBearerToken
