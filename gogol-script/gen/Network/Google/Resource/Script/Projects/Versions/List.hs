...
--
-- /See:/ <https://developers.google.com/apps-script/api/ Google Apps Script API Reference> for @script.projects.versions.list@.
module Network.Google.Resource.Script.Projects.Versions.List
    (
    -- * REST Resource
...
pvlPp :: Lens' ProjectsVersionsList Bool
pvlPp = lens _pvlPp (\ s a -> s{_pvlPp = a})
...
-- | OAuth bearer token.
pvlBearerToken :: Lens' ProjectsVersionsList (Maybe Text)
pvlBearerToken
  = lens _pvlBearerToken
      (\ s a -> s{_pvlBearerToken = a})
