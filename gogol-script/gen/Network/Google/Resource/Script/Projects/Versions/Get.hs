...
--
-- /See:/ <https://developers.google.com/apps-script/api/ Google Apps Script API Reference> for @script.projects.versions.get@.
module Network.Google.Resource.Script.Projects.Versions.Get
    (
    -- * REST Resource
...
pvgPp :: Lens' ProjectsVersionsGet Bool
pvgPp = lens _pvgPp (\ s a -> s{_pvgPp = a})
...
-- | OAuth bearer token.
pvgBearerToken :: Lens' ProjectsVersionsGet (Maybe Text)
pvgBearerToken
  = lens _pvgBearerToken
      (\ s a -> s{_pvgBearerToken = a})
