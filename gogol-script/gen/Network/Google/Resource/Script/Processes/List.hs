...
--
-- /See:/ <https://developers.google.com/apps-script/api/ Google Apps Script API Reference> for @script.processes.list@.
module Network.Google.Resource.Script.Processes.List
    (
    -- * REST Resource
                               ...
                               QueryParam "pageSize" (Textual Int32) :>
                                 QueryParam "userProcessFilter.projectName" Text
                                   ...
                                   QueryParams "userProcessFilter.statuses" Text
                                     :>
                                     QueryParam "userProcessFilter.scriptId"
                                       Text
                                       :>
...
-- | OAuth bearer token.
plBearerToken :: Lens' ProcessesList (Maybe Text)
plBearerToken
  = lens _plBearerToken
...
-- | Optional field used to limit returned processes to those originating
-- from projects with a specific project name.
