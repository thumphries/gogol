...
--
-- /See:/ <https://developers.google.com/apps-script/api/ Google Apps Script API Reference> for @script.processes.listScriptProcesses@.
module Network.Google.Resource.Script.Processes.ListScriptProcesses
    (
    -- * REST Resource
                         ...
                         QueryParam "uploadType" Text :>
                           QueryParam "scriptProcessFilter.deploymentId" Text :>
                             QueryParam "bearer_token" Text :>
                               QueryParam "scriptProcessFilter.startTime"
                                 DateTime'
                                 :>
...
plspPp :: Lens' ProcessesListScriptProcesses Bool
plspPp = lens _plspPp (\ s a -> s{_plspPp = a})
...
-- | OAuth bearer token.
plspBearerToken :: Lens' ProcessesListScriptProcesses (Maybe Text)
plspBearerToken
  = lens _plspBearerToken
      (\ s a -> s{_plspBearerToken = a})
