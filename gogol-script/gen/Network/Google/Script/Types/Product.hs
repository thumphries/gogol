...
-- represents exeuctions started via the Apps Script API.
--
...
--
-- /See:/ 'googleAppsScriptTypeScope' smart constructor.
data GoogleAppsScriptTypeScope = GoogleAppsScriptTypeScope'
    { _gastsAuthorizer :: !(Maybe GoogleAppsScriptTypeScopeAuthorizer)
    , _gastsName :: !(Maybe Text)
    } deriving (Eq,Show,Data,Typeable,Generic)

-- | Creates a value of 'GoogleAppsScriptTypeScope' with the minimum fields required to make a request.
--
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'gastsAuthorizer'
...
googleAppsScriptTypeScope = 
    GoogleAppsScriptTypeScope'
    { _gastsAuthorizer = Nothing
    , _gastsName = Nothing
    }

-- | Who authorized the scope.
gastsAuthorizer :: Lens' GoogleAppsScriptTypeScope (Maybe GoogleAppsScriptTypeScopeAuthorizer)
gastsAuthorizer
  = lens _gastsAuthorizer
      (\ s a -> s{_gastsAuthorizer = a})

-- | The scope\'s identifying string.
gastsName :: Lens' GoogleAppsScriptTypeScope (Maybe Text)
gastsName
  = lens _gastsName (\ s a -> s{_gastsName = a})

instance FromJSON GoogleAppsScriptTypeScope where
        parseJSON
          = withObject "GoogleAppsScriptTypeScope"
              (\ o ->
                 GoogleAppsScriptTypeScope' <$>
                   (o .:? "authorizer") <*> (o .:? "name"))

instance ToJSON GoogleAppsScriptTypeScope where
        toJSON GoogleAppsScriptTypeScope'{..}
          = object
              (catMaybes
                 [("authorizer" .=) <$> _gastsAuthorizer,
                  ("name" .=) <$> _gastsName])
...
--
-- /See:/ 'googleAppsScriptTypeScopeSet' smart constructor.
newtype GoogleAppsScriptTypeScopeSet = GoogleAppsScriptTypeScopeSet'
    { _gastssValues :: Maybe [GoogleAppsScriptTypeScope]
    } deriving (Eq,Show,Data,Typeable,Generic)

-- | Creates a value of 'GoogleAppsScriptTypeScopeSet' with the minimum fields required to make a request.
--
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'gastssValues'
...
googleAppsScriptTypeScopeSet = 
    GoogleAppsScriptTypeScopeSet'
    { _gastssValues = Nothing
    }

-- | List of scope values in the set.
gastssValues :: Lens' GoogleAppsScriptTypeScopeSet [GoogleAppsScriptTypeScope]
gastssValues
  = lens _gastssValues (\ s a -> s{_gastssValues = a})
      . _Default
      . _Coerce

instance FromJSON GoogleAppsScriptTypeScopeSet where
        parseJSON
          = withObject "GoogleAppsScriptTypeScopeSet"
              (\ o ->
                 GoogleAppsScriptTypeScopeSet' <$>
                   (o .:? "values" .!= mempty))

instance ToJSON GoogleAppsScriptTypeScopeSet where
        toJSON GoogleAppsScriptTypeScopeSet'{..}
          = object
              (catMaybes [("values" .=) <$> _gastssValues])
...
data Deployment = Deployment'
    ...
    , _dFunctionSet :: !(Maybe GoogleAppsScriptTypeFunctionSet)
    , _dUpdateTime :: !(Maybe DateTime')
    , _dScopeSet :: !(Maybe GoogleAppsScriptTypeScopeSet)
...
dFunctionSet :: Lens' Deployment (Maybe GoogleAppsScriptTypeFunctionSet)
dFunctionSet
  = lens _dFunctionSet (\ s a -> s{_dFunctionSet = a})
...
dScopeSet :: Lens' Deployment (Maybe GoogleAppsScriptTypeScopeSet)
dScopeSet
  = lens _dScopeSet (\ s a -> s{_dScopeSet = a})
